...
function Strategy(options, verify) {
  ...
  this.name = 'handword';
  this._getuidAPI = options.getuidAPI || 'http://api.handword.com/oauth2/resource/me?';
  this._getProfileAPI = options.getProfileAPI || 'http://api.handword.com/oauth2/resource/me?';
}
